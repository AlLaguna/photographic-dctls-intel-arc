...
__CONSTANT__ struct CineonColor cineon_colors[] = {
    ...
    { 0, 0.50f, 0.50f, 0.50f },  { 1, 1.00f, 0.95f, 0.25f },  { 2, 0.90f, 0.50f, 0.25f },  { 3, 0.90f, 0.60f, 0.25f },
    { 4, 0.90f, 0.30f, 0.20f },  { 5, 0.90f, 0.35f, 0.30f },  { 6, 0.90f, 0.90f, 0.90f },  { 7, 0.95f, 0.95f, 0.95f },
    { 8, 0.99f, 0.99f, 0.99f }
};
